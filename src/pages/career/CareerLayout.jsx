...
import dummyCarrers from '../../components/data/dummyCareers';

const CareerLayout = () => {
  const [careers, setCareers] = useState(dummyCarrers);
  ...
  const handleCareerCreated = (careerData) => {
    if (mode === "add") {
      setCareers(prev => [...prev, careerData]);
      toast.success('Career added successfully');
    } else {
      setCareers(prev => prev.map(c => c.id === careerData.id ? careerData : c));
